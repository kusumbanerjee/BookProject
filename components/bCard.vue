<template>
  <!-- the main..whole card design -->
  <div class="bg-white border border-black shadow-md p-2 my-8 mx-4 mb-2">
    <img class="w-full h-96 object-cover mb-4" :src="image" />

    <!-- displaying title, author from index pg -->
